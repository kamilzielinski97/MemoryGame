...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // wczytanie card obrazu
        frontOfCardsResource();

        // tasowanie obrazow
        Collections.shuffle(Arrays.asList(cardsArray));

        // zmienianie koloru dla kolejnego gracza
    ...
    private void doStuff(ImageView iv, int card){
        // ustawia poprawne image do imageView
        ...
        // sprawdza ktore zdjecie jest wybrane
        if(cardNumber == 1){
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    // sprawdza czy wybrane zdjecia sa podobne
                    calculate();
                }
            }, 1000);
    ...
    private void calculate() {
        // jesli zdjecia sa podobne usuawa i dodaje punkt
        if (firstCard == secondCard) {
            ...
            // dodaje punkty poprawnemy graczowi
            if (turn == 1) {
                playerPoints++;
        ...
        // sprawdza czy gra jest skonczona
        checkEnd();
    }
